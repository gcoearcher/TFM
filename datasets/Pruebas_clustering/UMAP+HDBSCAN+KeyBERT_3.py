...
# 1. Cargar dataset
df = pd.read_json("C:\\Users\\Usuario9\\OneDrive\\Documentos\\Master Big Data\\UPC - BIG DATA\\TFM\\TFM-main\\TFM-main\\datasets\\Kaggle\\csv\\DailyDialog.csv", encoding="utf-8")
